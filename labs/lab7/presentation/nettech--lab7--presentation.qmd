...
- PC1-alkamal, alkamal-sw-01, alkamal-gw-01
...
## Назначение IPv4-адреса интерфейсу eth0

- Интерфейс eth0
- Адрес: `10.0.0.1/24`
- Маршрутизатор — шлюз по умолчанию

![Назначение статического IPv4-адреса 10.0.0.1/24 интерфейсу eth0](image/3.png)



## Настройка DHCP-сервера (IPv4)

- Создан shared-network `alkamal`
- DNS: `10.0.0.1`
- Gateway: `10.0.0.1`
...
## DHCP-процесс на узле PC1 (Discover / Offer)

- DHCP Discover
- DHCP Offer
- Клиент без IP (0.0.0.0)

![Процесс обмена DHCP-сообщениями на узле PC1 (DHCP Discover и Offer)](image/6.png)
...
![Отсутствие аренд DHCPv6](image/18-1.png)
...
![DHCPv6 lease на маршрутизаторе](image/19-2.png)
